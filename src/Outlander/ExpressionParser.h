...
enum {
    EXPRESSIONPARSER_TOKEN_KIND_DEBUG = 14,
    ...
    EXPRESSIONPARSER_TOKEN_KIND_DEBUGLEVEL,
    EXPRESSIONPARSER_TOKEN_KIND_VARCMD,
    EXPRESSIONPARSER_TOKEN_KIND_NEXTROOM,
    EXPRESSIONPARSER_TOKEN_KIND_PARSE,
    ...
    EXPRESSIONPARSER_TOKEN_KIND_SENDCMD,
    EXPRESSIONPARSER_TOKEN_KIND_GOSUB,
    EXPRESSIONPARSER_TOKEN_KIND_VARS,
